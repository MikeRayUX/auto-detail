...
RSpec.describe 'users/dashboards/new_order_flow/refresh_wait_for_washers_controller', type: :request do
  ...
  scenario 'the order is past the accept by time and the customer clicks continue waiting button and the accept by time is extended' do
    ...
    travel_to(DateTime.current + 66.minutes) do
      ...
      put '/users/dashboards/new_order_flow/refresh_wait_for_washers/1', 
      params: {
        new_order: {
