class Api::V1::Users::Dashboards::NewOrderFlow::CancelPickupsController < ApiController
  before_action :ensure_order_exists, only: %i[update]

  layout 'users/dashboards/new_order_flow/order_layout'
  
  # /api/v1/users/dashboards/new_order_flow/cancel_pickups/1
  # api_v1_users_dashboards_new_order_flow_cancel_pickup_path
  # put
  def update
